...
public class MySQLHelp extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        final String insertValue2[][] = new String[][]{
                ...
                new String[] { "4", "花呗还款", "", "2017_10_08 00:00", "2017_10_10 23:59", "0", "", "每月", "无", ""},
                new String[] { "5", "京东白条还款", "", "2017_10_16 00:00", "2017_10_18 23:59", "0", "", "每月", "无", ""},
                new String[] { "6", "房贷还款", "", "2017_10_15 00:00", "2017_10_17 23:59", "0", "", "每月", "无", ""},
                ...
                new String[] { "9", "交房租", "", "2017_10_01 00:00", "2017_10_01 23:59", "0", "", "每月", "无", ""},
                new String[] { "10", "收房租", "", "2017_10_01 00:00", "2017_10_01 23:59", "0", "", "每月", "无", ""}
        };
        for (i = 0; i < 11; i++) {
